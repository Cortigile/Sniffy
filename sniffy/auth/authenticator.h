...
public slots:
    ...
    // Pending email used during manual browser-auth attempts
    QString getPendingEmail() const { return pendingManualEmail; }
...
private:
    ...
    void beginManualAttempt(const QString &email);
