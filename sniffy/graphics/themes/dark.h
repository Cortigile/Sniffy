...
#define DARK_WINDOW_DOCK_WIDGET DARK_COMPONENT_DISABLED   //actualy only undocked border color
...
"QDockWidget{border: 1px solid; background-color:" DARK_WINDOW_DOCK_WIDGET ";}"
