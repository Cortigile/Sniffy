...
#define DAWN_WINDOW_DOCK_WIDGET DAWN_COMPONENT_DISABLED   //actualy only undocked border color
...
"QDockWidget{border: 1px solid; background-color:" DAWN_WINDOW_DOCK_WIDGET ";}"
