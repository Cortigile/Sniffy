...
#define EMBER_WINDOW_DOCK_WIDGET EMBER_COMPONENT_DISABLED
...
/* SPECIAL PURPOSE */
#define EMBER_COMPONENT_DISABLED "#6b7489"
...
#define EMBER_STYLE_DOCK_WIDGET \
    "QDockWidget{border: 1px solid; background-color:" EMBER_WINDOW_DOCK_WIDGET ";}"
