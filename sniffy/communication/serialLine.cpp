...
QMutex &currentOpenPortMutex()
{
    static QMutex mutex;
    return mutex;
}

QString &currentOpenPortStorage()
{
    static QString portName;
    return portName;
}

void setCurrentOpenPort(const QString &portName)
{
    QMutexLocker locker(&currentOpenPortMutex());
    currentOpenPortStorage() = portName;
}
...
QString SerialLine::currentOpenPort()
{
    QMutexLocker locker(&currentOpenPortMutex());
    return currentOpenPortStorage();
}
