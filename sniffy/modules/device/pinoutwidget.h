...
private:
    ...
    QString leftMorphoId() const;
    QString rightMorphoId() const;
    QString leftArduinoTopId() const;
    QString leftArduinoBotId() const;
    QString rightArduinoTopId() const;
    QString rightArduinoBotId() const;

    bool usesSeparatedPinLabels() const;
    bool isLeftMorphoOuter(const PinDesc &pin) const;
    bool isRightMorphoOuter(const PinDesc &pin) const;
    bool isLeftMorphoInner(const PinDesc &pin) const;
    bool isRightMorphoInner(const PinDesc &pin) const;
    bool isLeftArduino(const PinDesc &pin) const;
    bool isRightArduino(const PinDesc &pin) const;
    bool isArduinoPin(const PinDesc &pin) const;
    QString separatedPinLabel(const PinDesc &pin) const;
    ...
    QTransform interactiveTransform(const QRectF &contentBounds, qreal marginPx) const;
    void resetView();
